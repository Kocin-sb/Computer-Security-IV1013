...
javac Hidenc.java
java Hidenc --key=0a40f2e6da4a1dee3a73453dbc77f51c --ctr=84bbd4ab12b4c654be4fac080a3e3f63 --input=task4.data --output=file4.data --offset=1312 --template=TEMPLATE
